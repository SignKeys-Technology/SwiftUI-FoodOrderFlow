...
struct RestaurantRepo {
    static let all = [
        ...
        Restaurant("Burger King", description: "Burgers, American", logo: "burgerking_logo", photo: "burgerking", orderTimeMin: 10, orderTimeMax: 15, color: Color(#colorLiteral(red: 0.05490196078, green: 0.3215686275, blue: 0.6509803922, alpha: 1)), rating: 4.8, priceRange: 3),
        ...
        Restaurant("Costa Coffee", description: "Coffee, Beverages", logo: "costacoffee_logo", photo: "coffee", orderTimeMin: 5, orderTimeMax: 10, color: Color(#colorLiteral(red: 0.5254901961, green: 0, blue: 0.1176470588, alpha: 1)), rating: 4.6, priceRange: 3)
    ]
